 ...
 <div class="panel panel-default">
   <div class="panel-heading">
     <h4 class="panel-title">
       ...
       <h3>Se lancer dans une Franchise</h3></a>
     </h4>
   </div>
 ...
 <div class="panel panel-default">
   ...
   <div id="collapse3" class="panel-collapse collapse">
     <div class="panel-body">
       ...
       Être franchisé Ratatouille c’est s’engager pour la bonne marche, le développement et la pérennisation de son restaurant,
       en sachant que la qualité de service de chaque restaurant impacte directement l’image de l’enseigne.
       L’aptitude et l’attitude commerciale sont donc les 1ers critères de recrutement des franchisés Ratatouille.
       Cela signifie travailler dur, car il s’agit d’un métier où il faut d’abord s’impliquer pour obtenir le retour d’investissement
       que l’on mérite. Connaître sa région d’implantation est un avantage considérable car un restaurant est avant tout
